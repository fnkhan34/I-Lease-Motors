    ...
    <>
      ...
      >
        <div className="ilm-container" style={{
          ...
          <a onClick={() => go('home')} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
            <img src="https://res.cloudinary.com/dsnifbbrw/image/upload/v1783108900/ilease_motors_logo_translucent_mrxinh.png" alt="I Lease Motors" style={{ height: 48, width: 'auto' }} />
          </a>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 28 }}>
          <img src="https://res.cloudinary.com/dsnifbbrw/image/upload/v1783108900/ilease_motors_logo_translucent_mrxinh.png" alt="I Lease Motors" style={{ height: 40 }} />
