  ...
  return (
    <footer style={{ background: 'var(--surface-1)', borderTop: '1px solid var(--border-1)', marginTop: 'var(--space-72)' }}>
      <div className="ilm-container" style={{ paddingBlock: 'var(--space-56)' }}>
        <div className="ilm-footer-grid" style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr 1fr 1.2fr', gap: 'var(--space-40)' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-16)', maxWidth: 300 }}>
            <img src="https://res.cloudinary.com/dsnifbbrw/image/upload/v1783108900/ilease_motors_logo_translucent_mrxinh.png" alt="I Lease Motors" style={{ height: 81, width: 'auto', alignSelf: 'flex-start' }} />
      ...
      <div style={{ borderTop: '1px solid var(--border-1)' }}>
        <div className="ilm-container ilm-footer-bottom" style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center', justifyContent: 'space-between', paddingBlock: 'var(--space-24)', fontSize: 12, color: 'var(--text-3)' }}>
